...
user in an INI file next to KasperskyTDSSKillerPortable.exe called KasperskyTDSSKillerPortable.ini.
...
copy AppNamePortable.ini from this directory to KasperskyTDSSKillerPortable.ini next to
KasperskyTDSSKillerPortable.exe. The options in the INI file are as follows:
